...
<option value="17">mod envelope decay</option></select></div>
<div class=slidercontainer>
macro knob 1 destination A:<select id="0300" >
<option value="0">osc 1 pitch</option>
<option value="1">osc 1 pitch</option>
<option value="2">osc 2 pitch</option>
<option value="3">osc 1 v-sync</option>
...
<div class=slidercontainer> Knob 1destination A:<select id="030" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
...
</select><div class=slidercontainer> Knob 1destination B:<select id="034" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
<option value="2">osc 1 virtual sync depth</option>
<option value="3">osc 1 density</option>
<option value="4">osc 1 density detune</option>
<option value="5">osc 1 semitones</option>
...
<option value="68">mod matrix 19 depth</option>
<option value="69">mod matrix 20 depth</option>
</select><div class=slidercontainer> Knob 1destination C:<select id="038" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
<option value="2">osc 1 virtual sync depth</option>
<option value="3">osc 1 density</option>
<option value="4">osc 1 density detune</option>
<option value="5">osc 1 semitones</option>
...
<option value="68">mod matrix 19 depth</option>
<option value="69">mod matrix 20 depth</option>
</select><div class=slidercontainer> Knob 1destination D:<select id="03C" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
<option value="2">osc 1 virtual sync depth</option>
<option value="3">osc 1 density</option>
<option value="4">osc 1 density detune</option>
<option value="5">osc 1 semitones</option>
...
<option value="68">mod matrix 19 depth</option>
<option value="69">mod matrix 20 depth</option>
</select><div class=slidercontainer> Knob 2destination A:<select id="0310" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
<option value="2">osc 1 virtual sync depth</option>
<option value="3">osc 1 density</option>
<option value="4">osc 1 density detune</option>
<option value="5">osc 1 semitones</option>
...
<option value="68">mod matrix 19 depth</option>
<option value="69">mod matrix 20 depth</option>
</select><div class=slidercontainer> Knob 2destination B:<select id="0314" oninput="sendNPRN(this.id,this.value);" ><option value="0">osc 1 wave interpolate</option><option value="1">osc 1 pulse width index</option>
<option value="2">osc 1 virtual sync depth</option>
<option value="3">osc 1 density</option>
<option value="4">osc 1 density detune</option>
<option value="5">osc 1 semitones</option>
